...
public class Edit_NewClass_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_new_class);
        ...
        databaseReference.child(userId).child(lopHocId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Edit_NewClass_Activity.this, "Không tìm thấy dữ liệu", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                // Xử lý khi truy vấn dữ liệu thất bại
                Toast.makeText(Edit_NewClass_Activity.this, "Lỗi: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        databaseReference.child(userId).child(lopHocId).setValue(lopHoc)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        // Cập nhật thành công
                        Toast.makeText(Edit_NewClass_Activity.this, "Cập nhật thành công", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        // Cập nhật thất bại
                        Toast.makeText(Edit_NewClass_Activity.this, "Cập nhật thất bại", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
